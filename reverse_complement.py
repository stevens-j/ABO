    ...
    for sample in sample_list:
        ...
        for variant in variant_list:
            ...
            if slash in variant:
                ...
                seq1 = str(Seq(indel[0]).reverse_complement())
                seq2 = str(Seq(indel[1]).reverse_complement())
...
def get_sample_variant_dictionary(file_handle):
    ...
    for line in file_handle:
        ...
        if line.startswith("#"):
            ...
            header_list[0] = "Sample"
            header_line = "\t".join(header_list)
        else:
            # process sample lines to create sample list and variant lists
            ...
            sample_variant_dict[sample] = line_list[1:]
